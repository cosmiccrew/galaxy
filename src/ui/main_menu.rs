...
impl Plugin for GalaxyMainMenuPlugin {
    fn build(&self, app: &mut App) {
        app.init_state::<MainMenuState>()
            ...
            .add_systems(OnEnter(EngineState::MainMenu), Self::setup)
            .add_systems(Update, Self::main_menu_button_system)
                ...
                parent
                    ...
                    .with_children(|parent| {
                        ...
                        let mut main_menu_button =
                            |button_type: MainMenuButton, state: ButtonState| {
...
mod tests {
    ...
    use super::{ButtonState, GalaxyMainMenuPlugin, MainMenuButton};
    use crate::prelude::*;
    ...
    fn test_main_menu_button_system() {
        ...
        app.init_state::<EngineState>()
            ...
            .add_systems(Update, GalaxyMainMenuPlugin::main_menu_button_system);
